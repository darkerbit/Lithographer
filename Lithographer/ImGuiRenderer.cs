	...
	public class ImGuiRenderer
	{
		...
		private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
		{
			...
			if (drawData.TotalVtxCount > _vertexBufferSize)
			{
				...
				_vertexBuffer = new DynamicVertexBuffer(_graphicsDevice, DrawVertDeclaration.Declaration,
			...
			if (drawData.TotalIdxCount > _indexBufferSize)
			{
				...
				_indexBuffer = new DynamicIndexBuffer(_graphicsDevice, IndexElementSize.SixteenBits, _indexBufferSize,
